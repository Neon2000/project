...
ActiveRecord::Schema.define(version: 2022_11_15_173505) do
  ...
  create_table "cmreviews", force: :cascade do |t|
    t.integer "star"
    t.integer "comment_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["comment_id"], name: "index_cmreviews_on_comment_id"
  end
  ...
  add_foreign_key "cmreviews", "comments"
